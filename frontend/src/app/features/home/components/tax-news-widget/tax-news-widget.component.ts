  ...
  readonly news: TaxNews[] = [
    {
      ...
      summary:
        'New guidance on the global minimum tax rules affecting groups with revenues exceeding EUR 750 million.',
      source: 'EY',
      sourceLogo: 'EY',
    ...
    },
    {
      ...
      summary:
        'Key dates and requirements for Country-by-Country reporting and Master File submissions.',
      source: 'OECD',
      sourceLogo: 'OECD',
