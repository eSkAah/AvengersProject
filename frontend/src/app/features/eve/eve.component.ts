    ...
    <div class="eve-page">
      ...
      <div class="eve-container">
        <div class="eve-header">
          ...
          <div
            class="eve-context-badge"
            [class.eve-context-badge--engagement]="eveService.contextMode() === 'engagement'"
          >
            <lucide-icon
              [name]="eveService.contextMode() === 'engagement' ? 'briefcase' : 'globe'"
              [size]="14"
            ></lucide-icon>
        ...
        <div class="eve-input">
          ...
          <button
            class="eve-send"
            (click)="onSend()"
            [disabled]="!inputValue() || eveService.isLoading()"
          >
...
export class EveComponent implements OnInit, AfterViewChecked {
  ...
  readonly breadcrumbs: BreadcrumbItem[] = [{ label: 'Home', path: '/' }, { label: 'Eve' }];
